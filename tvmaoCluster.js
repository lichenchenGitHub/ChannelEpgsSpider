...
if (cluster.isMaster) {
    ...
    //    kue.Job.rangeByType('links','failed', 0, 0, 'asc', function (err, jobs) {
    //        jobs.forEach(function(job){
    //            console.log("job "+job.id+": done err,ready to inactive");
    //            job.state("inactive").save();
    //            console.log(job.updated_at);
    //            console.log(job.created_at);
    //        });
    //    });
    //}
    //var reactiveInterval=setInterval(reactive,60000);
    ...
    var removeInterval = setInterval(removeJob, 1000 * 60 * 60 * 24);
